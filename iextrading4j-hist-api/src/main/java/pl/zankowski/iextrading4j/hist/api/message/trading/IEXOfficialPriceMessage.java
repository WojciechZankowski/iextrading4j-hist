...
public class IEXOfficialPriceMessage extends IEXMessage {
    ...
    public static IEXOfficialPriceMessage createIEXMessage(final IEXMessageType messageType, final byte[] bytes) {
        ...
        return new IEXOfficialPriceMessage(messageType, priceType, timestamp, symbol, price);
    }
